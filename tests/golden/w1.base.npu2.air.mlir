  ...
  func.func @gemm(%arg0: memref<64x64xf32>, %arg1: memref<64x64xf32>, %arg2: memref<64x64xf32>) {
    ...
    air.launch (%arg3, %arg4) in (%arg5=%c1, %arg6=%c1_0) args(%arg7=%arg0, %arg8=%arg1, %arg9=%arg2) : memref<64x64xf32>, memref<64x64xf32>, memref<64x64xf32> {
      air.segment @gemm_seg  args(%arg10=%arg7, %arg11=%arg8, %arg12=%arg9) : memref<64x64xf32>, memref<64x64xf32>, memref<64x64xf32> {
        ...
        air.herd @gemm_herd  tile (%arg13, %arg14) in (%arg15=%c2, %arg16=%c2_10) {
          %alloc = memref.alloc() : memref<32x32xf32, 2 : i32>
          %c0_19 = arith.constant 0 : index
          %c32 = arith.constant 32 : index
          %c1_20 = arith.constant 1 : index
          scf.for %arg17 = %c0_19 to %c32 step %c1_20 {
            %c0_24 = arith.constant 0 : index
            %c32_25 = arith.constant 32 : index
            %c1_26 = arith.constant 1 : index
            scf.for %arg18 = %c0_24 to %c32_25 step %c1_26 {
              %cst = arith.constant 0.000000e+00 : f32
              memref.store %cst, %alloc[%arg17, %arg18] : memref<32x32xf32, 2 : i32>
            }
          }
          %c0_21 = arith.constant 0 : index
          %c64_22 = arith.constant 64 : index
          %c16_23 = arith.constant 16 : index
          scf.for %arg17 = %c0_21 to %c64_22 step %c16_23 {
            %alloc_24 = memref.alloc() : memref<32x16xf32, 2 : i32>
            %alloc_25 = memref.alloc() : memref<16x32xf32, 2 : i32>
            %2 = affine.apply #map()[%arg13]
            %3 = affine.apply #map()[%arg14]
            air.channel.get  @A2L1[%2, %3] (%alloc_24[] [] []) : (memref<32x16xf32, 2 : i32>)
            %4 = affine.apply #map()[%arg13]
            %5 = affine.apply #map()[%arg14]
            air.channel.get  @B2L1[%4, %5] (%alloc_25[] [] []) : (memref<16x32xf32, 2 : i32>)
            %c0_26 = arith.constant 0 : index
            %c32_27 = arith.constant 32 : index
            %c1_28 = arith.constant 1 : index
            scf.for %arg18 = %c0_26 to %c32_27 step %c1_28 {
              ...
              scf.for %arg19 = %c0_29 to %c32_30 step %c1_31 {
                ...
                scf.for %arg20 = %c0_32 to %c16_33 step %c1_34 {
                  %6 = memref.load %alloc[%arg18, %arg19] : memref<32x32xf32, 2 : i32>
                  %7 = memref.load %alloc_24[%arg18, %arg20] : memref<32x16xf32, 2 : i32>
                  %8 = memref.load %alloc_25[%arg20, %arg19] : memref<16x32xf32, 2 : i32>
                  %9 = arith.mulf %7, %8 : f32
                  %10 = arith.addf %6, %9 : f32
                  memref.store %10, %alloc[%arg18, %arg19] : memref<32x32xf32, 2 : i32>
                }
              }
            }
            memref.dealloc %alloc_25 : memref<16x32xf32, 2 : i32>
            memref.dealloc %alloc_24 : memref<32x16xf32, 2 : i32>
          }
          %0 = affine.apply #map()[%arg13]
