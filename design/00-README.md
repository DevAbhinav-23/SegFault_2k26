...
*Phase 1 (design) document set, 2026-09-12. **No implementation code exists yet.** Nothing in
this directory has been built or run; every AIR fact it rests on was verified or measured in
...
| M4 (W1 / W3 / W2 / flip) | not started | B | D2 / D4 / D5 / D6 |
| M5 | not started | B | D1 skeleton, D2 real |
| M6 | not started | C | D2 |
| M7 harness, M8 fixtures | not started | C | D1 |
| **W1 end to end** | not started | B, C | **gate G2, D2** |
| **W3 end to end** | not started | B, C | **gate G3, D4** |
| **W2 end to end** | not started | B, C | **gate G4, D5** |
| **W1 weight-stationary flip** (stretch) — 1-D `grid(PK=4)`, `place(px=ax.k0)`, `j` untiled, ascending cascade | not started | B | **gate G5, D6 midday**; the designated cut if the plan runs over |
